...
response = requests.post(
    'https://api.llmadaptive.uk/v1beta/models/gemini-2.5-pro/generateContent',
    headers={
...
```bash cURL
curl -X POST https://api.llmadaptive.uk/v1beta/models/gemini-2.5-pro/generateContent \
