  ...
  **Control intelligent routing** to optimize cost and performance
  ...
  <Expandable title="Full Configuration">
    ...
    <ParamField body="models" type="array">
      ...
      - `{ provider: "anthropic", model_name: "claude-4-5-sonnet" }` - Specific model
    </ParamField>
  ...
  <Expandable title="Model Router Config">
    <ParamField body="models" type="ModelCapability[]">
      ...
      **Simple formats:**
      ...
      - `{ "provider": "anthropic", "model_name": "claude-4-5-sonnet" }` - Use specific model
...
<ResponseField name="model" type="string">
   Model used for the completion (format: author/model_name)
</ResponseField>
...
const completion = await openai.chat.completions.create({
  ...
  model_router: {
    models: [
      ...
      { provider: "openai", model_name: "gpt-5.1" } // Specific OpenAI model
    ],
