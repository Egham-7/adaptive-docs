...
response = requests.post(
    'https://api.llmadaptive.uk/v1beta/models/gemini-2.5-flash/streamGenerateContent',
    headers={
...
```bash cURL
curl -N -X POST https://api.llmadaptive.uk/v1beta/models/gemini-2.5-flash/streamGenerateContent \
