...
All implementation examples assume the OpenAI SDK is configured to call Adaptive:
...
Yes, zero completion insurance works with all models available through Adaptive.
</Accordion>
