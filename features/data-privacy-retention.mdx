...
completion = client.chat.completions.create(
    ...
    model_router={
      "models": [
        "groq:llama-3.1-8b-instant",      // Zero retention
        "fireworks:accounts/fireworks/models/llama-v3p1-8b-instruct", // Zero retention
        "together:meta-llama/Meta-Llama-3.1-8B-Instruct-Turbo"   // Zero retention
      ]
    }
)
```
