...
await generateText({
  ...
  providerOptions: {
    adaptive: {
      ...
      model_router: {
        models: [
          "anthropic:claude-3-5-sonnet-20241022", // Specific Anthropic model
...
<Accordion title="semantic_cache - Semantic Caching">
...
await generateText({
  ...
  providerOptions: {
    adaptive: {
      ...
      model_router: {
        models: [
          "openai:gpt-4o-mini", // Standard provider
