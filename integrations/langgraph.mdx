...
```bash yarn
yarn add @langchain/core @langchain/langgraph @langchain/openai
```
...
model="adaptive/auto", # Empty string enables intelligent routing
temperature=0,
)
...
const model = new ChatOpenAI({
  ...
  modelName: "adaptive/auto", // Empty string enables intelligent routing
  temperature: 0,
});
````
...
const model = new ChatOpenAI({
  ...
  modelName: "adaptive/auto", // Intelligent routing with automatic retries
  temperature: 0,
});
