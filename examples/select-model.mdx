...
```bash cURL
curl -X POST "https://api.llmadaptive.uk/v1/select-model" \
...
const performanceResponse = await fetch("https://api.llmadaptive.uk/v1/select-model", {
  method: "POST",
  headers: {
    "X-Stainless-API-Key": "your-adaptive-api-key",
    "Content-Type": "application/json",
...
const costResponse = await fetch("https://api.llmadaptive.uk/v1/select-model", {
  method: "POST",
  headers: {
    "X-Stainless-API-Key": "your-adaptive-api-key",
    "Content-Type": "application/json",
...
const functionResponse = await fetch("https://api.llmadaptive.uk/v1/select-model", {
  method: "POST",
  headers: {
    "X-Stainless-API-Key": "your-adaptive-api-key",
    "Content-Type": "application/json",
...
const customResponse = await fetch("https://api.llmadaptive.uk/v1/select-model", {
  method: "POST",
  headers: {
    "X-Stainless-API-Key": "your-adaptive-api-key",
    "Content-Type": "application/json",
...
async function demonstrateModelSelection() {
  ...
  const baseURL = "https://api.llmadaptive.uk/v1";
...
<Columns cols={3}>
  ...
  <Card title="OpenAI SDK Integration" icon="/images/logos/openai.svg" href="/integrations/openai-sdk">
