...
icon: "/images/logos/roo-code.jpeg"
---
...
<Tip>
  **Save 60-90% on AI development costs** with intelligent model routing. Roo
  Code's project analysis features work seamlessly with Adaptive's API.
</Tip>
