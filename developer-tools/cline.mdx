...
description: "Set up Cline VS Code extension with Adaptive's intelligent LLM routing for 60-90% cost savings"
icon: "code"
---

Configure Cline VS Code extension to use Adaptive's intelligent routing for 60-90% cost savings while maintaining the same AI-assisted development experience.

<Tip>
**Save 60-90% on AI development costs** with intelligent model routing. Works as a drop-in replacement in your favorite VS Code AI assistant.
</Tip>
...
<Steps>
  ...
  <Step title="Configure API Settings" icon="gear">
    ...
    Base URL: https://api.llmadaptive.uk/v1
