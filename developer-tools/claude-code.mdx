...
<Tip>
**Save 60-90% on AI development costs** with intelligent model routing. Works as a drop-in replacement for the Claude API.
</Tip>
...
export ANTHROPIC_BASE_URL=https://api.llmadaptive.uk/v1
...
# Create ~/.claude/settings.json
{
  "env": {
    ...
    "ANTHROPIC_BASE_URL": "https://api.llmadaptive.uk/v1"
  }
}
```
