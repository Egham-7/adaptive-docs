...
<Steps>
  <Step title="Run Installer" icon="download">
    ```bash curl -o claude-code.sh
    https://raw.githubusercontent.com/Egham-7/adaptive/main/scripts/installers/claude-code.sh
    chmod +x claude-code.sh ./claude-code.sh ```
  </Step>
  <Step title="Launch Claude Code" icon="play">
    ```bash claude ``` Select "Yes" when prompted about using the API key.
  </Step>
