...
curl https://api.llmadaptive.uk/v1/chat/completions \
  ...
  -d '{"model": "adaptive/auto", "messages": [{"role": "user", "content": "Hello!"}]}'
```
</Tab>
...
curl https://api.llmadaptive.uk/v1/messages \
  ...
  -d '{"model": "adaptive/auto", "max_tokens": 1000, "messages": [{"role": "user", "content": "Hello!"}]}'
```
</Tab>
</Tabs>
...
func main() {
    client := openai.NewClient(
        ...
        option.WithBaseURL("https://api.llmadaptive.uk/v1"),
    )
    ...
    completion, err := client.Chat.Completions.New(context.Background(), openai.ChatCompletionNewParams{
        ...
        Model: openai.String("adaptive/auto"), // Empty for intelligent routing
    })
...
$response = $client->post('https://api.llmadaptive.uk/v1/chat/completions', [
    'headers' => [
...
```dockerfile
# Dockerfile
ENV ADAPTIVE_API_KEY=apk_123456
...
type: Opaque
data:
   api-key: YXBrXzEyMzQ1Ng== # base64 encoded "apk_123456"
